...
import { UserPlus, Trash2, Shield, Mail, Eye, Pencil, X } from "lucide-react";
...
function AdminUsersPage() {
  ...
  const handleRemove = async (id: number, adminEmail: string) => {
    if (adminEmail.toLowerCase() === user?.email?.toLowerCase()) {
      if (!confirm("Are you sure you want to remove your own access?")) {
        return;
      }
    }
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-sm text-gray-500 mb-6">
        Control who can sign in to the admin portal and at what level. Accounts
        and passwords themselves are managed by Netlify Identity.
      </p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 mb-6">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Add the email address of someone who should be able to use the portal.
          They sign in with their Netlify Identity account, and their access
          level here decides what they can do.
        </p>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
        <p className="text-sm text-blue-800">
          <strong>How accounts work:</strong> This list only controls portal
          access and roles. To create a login, invite the person from the
          <strong> Identity</strong> tab in your Netlify dashboard; they will
          receive an email to set their own password. Password resets are
          handled the same way — through the &ldquo;Forgot your password?&rdquo;
          link on the login page or by Netlify Identity. Revoking access here
          does not delete the person&rsquo;s Netlify Identity account.
        </p>
      </div>
            ...
            <form onSubmit={handleEditSave} className="p-5 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  This should match the email on their Netlify Identity account.
                </p>
              </div>
